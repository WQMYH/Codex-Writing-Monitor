...
| --- | --- | --- | --- | --- | --- |
| M0 Host probe | review_ready | pending | pending | pending | Freeze CommitSet and run independent review |
...
- Installed probe version: `0.1.0+codex.20260901162103`.
...
- Honest limitation: the current Codex host did not expose enough evidence to prove that the MCP Apps React component rendered; M0 therefore supports the text renderer and records component rendering as unverified.
