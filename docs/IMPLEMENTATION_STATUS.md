...
| M1 Core contracts | paused_blocked | exceptional repair review failed with 1 Important | pending | revision 4 frozen | Await user resume; fix legacy approval timezone/expiry fail-closed path |
